...
describe('DepositNodeOperator', function () {
  ...
  describe('AddValidators', function(){
    it('Should add validators successfully', async function () {
      ...
      expect(await nodeOperator.getWithdrawalCredentials()).to.hexEqual('0x010000000000000000000000'.concat(rewardsVaultAddr.slice(2)));
      ...
      await expect(nodeOperator.addValidators(pubkeys, signatures, { value: BigNumber.from(minOperatorStakingAmount).mul(2) }))
        .to.emit(nodeOperator, 'SigningKeyAdded')
        .withArgs(0, '0x957f3a659faa3cdcd21be00a05b7bbca25a41b2f2384166ca5872363c37110b3dedbab1261179338fadc4ff70b4bea57')
        .to.emit(nodeOperator, 'SigningKeyAdded')
        .withArgs(1, '0x976b8dc5e9390c75d129609634fec912d3d5b2fcb5ef4badb806a68680d11df640cba696619be05896e0705c32db629b');
    ...
    it('Each should add validators successfully', async function () {
      ...
      await expect(nodeOperator2.connect(otherAccount).addValidators(pubkey2, signature2, { value: minOperatorStakingAmount }))
    ...
    it('Should revert if public keys length is not correct', async function () {
      const { nodeOperator, nodeManager } = await loadFixture(deployDepositNodeOperator);
      const pubkey =
        '0x957f3a659faa3cdcd21be00a05b7bbca';
      const signature =
        '0xa10eba2dbd2d8c2030b3a13b4cdd52912b324f127ba9b56ed7713d16941245b9d664610ebac541fbd58e64bc1cc598410ccf8795c418ee43d1a4a3842bcbc5fbf45da3abf742e45b98db1e00faebbf8ce477df37496eddf4a00d72905ec71a48';
      const minOperatorStakingAmount = await nodeManager.getMinOperatorStakingAmount();
      await expect(nodeOperator.addValidators(pubkey, signature, { value: minOperatorStakingAmount })).to.be.revertedWith(
        'Inconsistent public keys len!',
      );
    });
    ...
    it('Should revert if any account except operator adds validators', async function () {
      ...
      const signature =
        '0xa10eba2dbd2d8c2030b3a13b4cdd52912b324f127ba9b56ed7713d16941245b9d664610ebac541fbd58e64bc1cc598410ccf8795c418ee43d1a4a3842bcbc5fbf45da3abf742e45b98db1e00faebbf8ce477df37496eddf4a00d72905ec71a48';
      const minOperatorStakingAmount = await nodeManager.getMinOperatorStakingAmount();
      await expect(nodeOperator.connect(otherAccount).addValidators(pubkey, signature, { value: minOperatorStakingAmount })).to.be.revertedWith(
    ...
    it('Should revert does not have enough stakes', async function () {
      ...
      const signature =
        '0xa10eba2dbd2d8c2030b3a13b4cdd52912b324f127ba9b56ed7713d16941245b9d664610ebac541fbd58e64bc1cc598410ccf8795c418ee43d1a4a3842bcbc5fbf45da3abf742e45b98db1e00faebbf8ce477df37496eddf4a00d72905ec71a48';
      await expect(nodeOperator.addValidators(pubkey, signature)).to.be.revertedWith(
        'Not enough deposits!',
      );
    });
  });
