...
async function main() {
  ...
  console.log(
    'user 0x2bA0f16Ee6C18d5bca0ba140588077C9fF606fbD balance: ',
    await dawnDeposit.balanceOf('0x2bA0f16Ee6C18d5bca0ba140588077C9fF606fbD'),
  );
  ...
  console.log(
    'DepositNodeManager balance: ',
    await dawnDeposit.balanceOf('0x1E4f4fd4513dCE5FdD51e7e00c9ea0Ca093986cD'),
  );
  // DepositNodeOperator：0x2acd68AF4211BC82Ca526BE28e2fF3A1cfb424c5
  console.log(
    'DepositNodeOperator balance: ',
    await dawnDeposit.balanceOf('0x2acd68AF4211BC82Ca526BE28e2fF3A1cfb424c5'),
  );
  ...
  console.log(
    'DepositContract: ',
    await dawnStorage.getAddress(keccak256(encodePacked('contract.address', 'DepositContract'))),
  );
}
